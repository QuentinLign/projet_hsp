...
if(isset($_POST['submit']))
{
    $userid=$_SESSION['id'];
    $bdd = new bdd;
    $req=$bdd->getStart()->prepare("insert into rendezvous(doctorSpecilization,docteurID,userID,RDVdate,RDVheure) values(?,?,'$userid',?,?");
    $req->execute(array(
    ...
    if($req)
    {
        ...
        echo "<script>alert('ERREUR 404');</script>";
    }
