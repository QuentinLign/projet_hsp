    ...
    <div class="card card-body">
        ...
        <form action="class/mvc/traitement_rdv_med.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input class="form-control form-control-lg" type="text" name="lm" placeholder="Entrer votre prenom" required/>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="doctorSpecilization" class="form-control"  required="required">
                    ...
                    $bdd = new bdd;
                    $req=$bdd->getStart()->prepare("select * from hopital_externe");
                    $req->execute(array(
                    ));
                    ...
                    {
                        ?>
                        <option value="<?php echo ($req['hopital_externe']);?>">
                            <?php echo ($req['hopital_externe']);?>
                        </option>
                    <?php } ?>
            ...
            <div class="col-lg-12 no-pdd">
                <button type="submit" class="btn btn-lg btn-primary" value="submit">  Valider l'offre</button>
            </div>
